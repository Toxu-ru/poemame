...
function do_post_subheader($content, $selected = false, $rss = false, $rss_title = '') {
	...
	if ($rss && ! empty ($content)) {
		...
		echo '<li class="icon wideonly"><a href="'.$globals['base_url'].$rss.'" title="'.$rss_title.'"><img src="'.$globals['base_static'].'img/poemame/rss.png" width="15" height="15" alt="rss2"/></a></li>';
	}
