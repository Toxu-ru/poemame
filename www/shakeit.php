...
function print_shakeit_tabs($option=-1) {
	...
	$items = array();
	$items[] = array('id' => 1, 'url' => 'queue'.$globals['meta_skip'], 'title' => _('todos'));
	...
	$items[] = array('id' => 3, 'url' => 'queue?meta=_popular', 'title' => _('candidatos'));
	...
	if (!$globals['bot']) {
		$items [] = array('id' => 5, 'url' => 'queue?meta=_discarded', 'title' => _('descartados'));
	}
