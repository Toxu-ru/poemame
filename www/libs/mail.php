...
set_include_path("." . PATH_SEPARATOR . "/usr/share/php" . PATH_SEPARATOR . get_include_path());
...
function send_recover_mail ($user) {
	...
	$message .= "<p>--\n <br>el equipo de poémame<p><br></body></html>";
...
function send_pear_mail($to, $domain, $subject, $message) {
	...
	// $text = clean_string($message); Error en clean_string. Lo elimino:
	$text = $message;
