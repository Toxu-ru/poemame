...
class User {
	...
	static function get_menu_items($view, $user) {
		...
		$items[] = new MenuOption(_('subs'), get_user_uri($user, 'subs'), $id, _('sub poémames'));
		$items[] = new MenuOption(_('poemas'), get_user_uri($user, 'history'), $id, _('información de poemas enviados'));
